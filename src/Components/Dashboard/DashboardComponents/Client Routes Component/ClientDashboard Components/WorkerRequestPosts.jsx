        ...
        <div className="w-full mx-auto">
            {postData && postData.length > 0 ? (
                            ...
                            <div className="px-5 py-3 border-t border-gray-100">
                                ...
                                <div className="flex items-center mt-3 space-x-3">
                                    ...
                                    <button
                                        ...
                                        className="bg-gradient-to-r from-indigo-600 to-indigo-500 text-white px-5 py-2 rounded-full text-sm font-semibold hover:from-indigo-700 hover:to-indigo-600 transition-all shadow-md hover:shadow-lg transform hover:-translate-y-0.5"
                                    >
                                        Connect
                                    </button>
                                </div>
                ...
                <div className="max-w-full mx-auto p-8 bg-white rounded-xl shadow-sm border border-gray-100 text-center mt-4">
                    ...
                    <button className="bg-indigo-100 text-indigo-600 px-4 py-2 rounded-lg text-sm font-medium hover:bg-indigo-200 transition-colors">
                        Refresh Page
                    </button>
                </div>
            )}
