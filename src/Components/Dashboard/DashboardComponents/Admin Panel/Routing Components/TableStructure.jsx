                    ...
                    <div class="block">
                            ...
                            <table class="w-full rounded-xl">
                                <thead>
                                    <tr class="bg-gray-50">
                                        ...
                                        <th scope="col" class="p-5 text-left whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 capitalize"> First Name</th>
                                        <th scope="col" class="p-5 text-left whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 capitalize min-w-[150px]"> Email</th>
                                        <th scope="col" class="p-5 text-left whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 capitalize"> Role </th>
                                    ...
                                    {data.users.map((user, index) => {
                                        ...
                                        return (
                                            <tr key={index} class="bg-white transition-all duration-500 hover:bg-gray-50">
                                                ...
                                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">   {profile ? profile.first_name : 'N/A'}</td>
                                                <td class=" px-5 py-3">
                                                        ...
                                                        {profile && profile.profile_image ? (
                                                            ...
                                                            <div className="w-10 h-10 rounded-full bg-gray-200 flex items-center justify-center">
                                                                <span className="text-gray-500 text-sm">
                                                                    {profile ? profile.first_name.charAt(0) + profile.last_name.charAt(0) : 'NA'}
                                                                </span>
                                                            </div>
                                                        )}
                                                        <div class="data">
                                                            <p class="font-normal text-sm text-gray-900">{profile ? profile.first_name : 'N/A'}</p>
                                                            <p class="font-normal text-xs leading-5 text-gray-400"> {profile ? profile.email : ''} </p>
                                                        </div>
                                                    </div>
                                                </td>
                                                    ...
                                                    <div className={`py-1.5 px-2.5 rounded-full flex justify-center w-20 items-center gap-1 ${user.role === 'admin' ? 'bg-purple-50' :
                                                        ...
                                                        <svg width="5" height="6" viewBox="0 0 5 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <circle cx="2.5" cy="3" r="2.5" fill={
                                                                user.role === 'admin' ? '#7E22CE' :
                                                                    user.role === 'worker' ? '#1D4ED8' :
                                                                        '#059669'
                                                            }></circle>
                                                        </svg>
                        ...
                        <nav class="flex items-center justify-center py-4 " aria-label="Table navigation">
                            <ul class="flex items-center justify-center text-sm h-auto gap-12">
                                <li>
                                    <a href="javascript:;" class="flex items-center justify-center gap-2 px-3 h-8 ml-0 text-gray-500 bg-white font-medium text-base leading-7  hover:text-gray-700 ">
                                        <svg width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M13.0002 14.9999L8 9.99967L13.0032 4.99652" stroke="black" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"></path>
                                        </svg> Back </a>
                                </li>
                                <li>
                                    <ul class="flex items-center justify-center gap-4">
                                        <li>
                                            <a href="javascript:;" class="font-normal text-base leading-7 text-gray-500 py-2.5 px-4 rounded-full bg-white transition-all duration-500 hover:bg-indigo-600 hover:text-white">1</a>
                                        </li>
                                        <li>
                                            <a href="javascript:;" class="font-normal text-base leading-7 text-gray-500 py-2.5 px-4 rounded-full bg-white transition-all duration-500 hover:bg-indigo-600 hover:text-white">2</a>
                                        </li>
                                        <li>
                                            <a href="javascript:;" class="font-normal text-base leading-7 text-gray-500 py-2.5 px-4 rounded-full bg-white transition-all duration-500 hover:bg-indigo-600 hover:text-white">3</a>
                                        </li>
                                        <li>
                                            <a href="javascript:;" class="font-normal text-base leading-7 text-gray-500 py-2.5 px-4 rounded-full bg-white transition-all duration-500 hover:bg-indigo-600 hover:text-white">4</a>
                                        </li>
                                        <li>
                                            <a href="javascript:;" class="font-normal text-base leading-7 text-gray-500 py-2.5 px-4 rounded-full bg-white transition-all duration-500 hover:bg-indigo-600 hover:text-white">5</a>
                                        </li>
                                        <li>
                                            <a href="javascript:;" class="font-normal text-base leading-7 text-gray-500 py-2.5 px-4 rounded-full ">
                                                <svg width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M5.52754 10.001H5.47754M10.5412 10.001H10.4912M15.5549 10.001H15.5049" stroke="black" stroke-width="2.5" stroke-linecap="round"></path>
                                                </svg>
                                            </a>
                                        </li>
                                    </ul>
                                ...
                                <li>
                                    <a href="javascript:;" class="flex items-center justify-center gap-2 px-3 h-8 ml-0 text-gray-500 bg-white font-medium text-base leading-7  hover:text-gray-700 "> next <svg width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M8.00295 4.99646L13.0032 9.99666L8 14.9998" stroke="black" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"></path>
                                    </svg>
                                    </a>
                                </li>
                            </ul>
