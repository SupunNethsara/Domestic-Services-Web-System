                    ...
                    <div className="p-6 overflow-y-auto max-h-[80vh]">
                        {submitting ? (
                            <div className="flex flex-col items-center justify-center py-12">
                                ...
                                <p className="text-gray-700">Submitting your availability...</p>
                            </div>
                        ) : (
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div className="flex justify-end gap-3 pt-4 border-t border-gray-200">
                                    ...
                                    <button
                                        type="submit"
                                        className="px-6 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-md transition-colors flex items-center justify-center"
                                        disabled={submitting}
                                    >
                                        {submitting ? (
                                            <>
