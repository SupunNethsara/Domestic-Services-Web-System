...
export default function WorkerPostModal({postmodal ,closemodal }) {
    ...
    const uploadImageToCloudinary = async (file) => {
        ...
        try {
            ...
            throw new Error('image upload failed for Cloudinary');
        }
    };
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post(
                'http://127.0.0.1:8000/api/workpost',
                postData,
                {
                    headers: {
                ...
                <form onSubmit={handleSubmit}>
                                    ...
                                    {imagePreview ? (
                                        <div className="relative">
                                            <img
                                                src={imagePreview}
                                                alt="Preview"
                                                className="mx-auto max-h-64 w-full object-contain rounded-lg"
                                            />
                                            <button
                                                type="button"
                                                onClick={() => {
                    ...
                    <div className="flex items-center justify-end p-4 border-t border-gray-200">
                        ...
                        <button
                            ...
                            className={`px-4 py-2 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 ${(!formData.content.trim() || isSubmitting) ? 'opacity-50 cursor-not-allowed' : ''
                                }`}
                        >
                            {isSubmitting ? (
